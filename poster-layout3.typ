...
#place(top + left, dx: 5cm, dy: 29cm, rect(width: 34.8cm, height: 6cm, fill: cmyk(5%,2%,0%,0%), stroke: (paint: line, thickness: 0.6pt), radius: 4pt))
#place(top + left, dx: 6cm, dy: 30.6cm, text(size: 18pt, weight: "bold", fill: navy)[ABSTRACT])
