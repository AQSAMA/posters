...
#place(top + left, dx: 0cm, dy: 0cm, rect(width: 100%, height: 26cm, fill: steel))
#place(top + left, dx: 0cm, dy: 0cm, rect(width: 100%, height: 25.5cm, fill: cmyk(2%,1%,2%,0%)))
#place(top + center, dy: 17.5cm, text(size: 30pt, weight: "bold", fill: navy)[Artificial Intelligence and Machine Learning in Drug Design])
#place(top + center, dy: 21cm, text(size: 30pt, weight: "bold", fill: navy)[الذكاء الاصطناعي والتعلم الآلي في تصميم الأدوية])
#place(top + left, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(0%,0%,0%,0%), stroke: (paint: cmyk(35%,12%,8%,8%), thickness: 1.2pt), radius: 6pt))
#place(top + right, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(0%,0%,0%,0%), stroke: (paint: cmyk(35%,12%,8%,8%), thickness: 1.2pt), radius: 6pt))
...
#place(top + right, dx: 5cm, dy: 32cm, align(right, box(width: 34.8cm)[#set text(dir: rtl)
...
#place(top + right, dx: 5cm, dy: 60cm, align(right, box(width: 34.8cm)[#set text(dir: rtl)
