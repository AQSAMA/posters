...
#place(top + left, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(2%,1%,0%,0%), stroke: (paint: line, thickness: 0.8pt)))
#place(top + right, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(0%,1%,2%,0%), stroke: (paint: line, thickness: 0.8pt)))
#place(top + center, dy: 27cm, rect(width: 0.45cm, height: 85cm, fill: steel))
