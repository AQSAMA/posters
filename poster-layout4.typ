...
#place(top + center, dy: 19.1cm, text(size: 28pt, weight: "bold", fill: navy)[Artificial Intelligence and Machine Learning in Drug Design])
#place(top + center, dy: 21cm, text(size: 30pt, weight: "bold", fill: navy)[الذكاء الاصطناعي والتعلم الآلي في تصميم الأدوية])
#place(top + left, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(0%,0%,0%,0%), stroke: (paint: navy, thickness: 3pt)))
#place(top + right, dx: 4cm, dy: 27cm, rect(width: 36.8cm, height: 85cm, fill: cmyk(0%,0%,0%,0%), stroke: (paint: navy, thickness: 3pt)))
