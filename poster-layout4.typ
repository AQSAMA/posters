...
#let navy = cmyk(94%, 64%, 26%, 30%)
#let accent = cmyk(64%, 30%, 20%, 12%)
#let line = cmyk(18%, 8%, 8%, 12%)
#let paper = cmyk(2%, 2%, 2%, 0%)
#let panel = cmyk(3%, 2%, 2%, 0%)
...
#let header-height = 23cm
#let body-top = 26cm
#let row-gap = 2.4cm
#let row1-height = 28cm
#let row2-height = 24cm
#let row3-height = 20cm
#let row-pad = 1.4cm

#rect(width: 100%, height: 100%, fill: paper)
#place(top + left, dx: 0cm, dy: 0cm, rect(width: 1.2cm, height: 100%, fill: accent))
#place(top + right, dx: 0cm, dy: 0cm, rect(width: 1.2cm, height: 100%, fill: accent))

#place(top + left, dx: 0cm, dy: 0cm, rect(width: 100%, height: header-height, fill: cmyk(4%, 2%, 3%, 0%)))
#place(top + left, dx: 0cm, dy: header-height - 1cm, rect(width: 100%, height: 0.28cm, fill: accent))
...
#place(top + left, dx: side, dy: body-top,
  rect(width: column-width * 2 + 2.5cm, height: row1-height, fill: panel, stroke: (paint: line, thickness: 0.8pt))
)
#place(top + left, dx: side + row-pad, dy: body-top + row-pad,
  box(width: column-width - row-pad)[
...
#place(top + right, dx: side + row-pad, dy: body-top + row-pad,
  align(right, box(width: column-width - row-pad)[
...
#let row2-top = body-top + row1-height + row-gap
#place(top + left, dx: side, dy: row2-top,
  rect(width: column-width * 2 + 2.5cm, height: row2-height, fill: panel, stroke: (paint: line, thickness: 0.8pt))
)
#place(top + left, dx: side + row-pad, dy: row2-top + row-pad,
  box(width: column-width - row-pad)[
...
#place(top + right, dx: side + row-pad, dy: row2-top + row-pad,
  align(right, box(width: column-width - row-pad)[
...
#let row3-top = row2-top + row2-height + row-gap
#place(top + left, dx: side, dy: row3-top,
  rect(width: column-width * 2 + 2.5cm, height: row3-height, fill: panel, stroke: (paint: line, thickness: 0.8pt))
)
#place(top + left, dx: side + row-pad, dy: row3-top + row-pad - 0.2cm,
  box(width: column-width - row-pad)[
...
#place(top + right, dx: side + row-pad, dy: row3-top + row-pad - 0.2cm,
  align(right, box(width: column-width - row-pad)[
